...
namespace device
{
    namespace controller
    {
        ...
        {
            listener.listen<Event::Config::Controller>([&](auto)
                                                       { reload(); });
        ...
        Controller::~Controller() { listener.unlistenAll(); }
