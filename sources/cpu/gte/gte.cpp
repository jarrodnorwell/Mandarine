...
GTE::GTE() : unrTable(generateUnrTable())
{
    ...
    listener.listen<Event::Config::Gte>([&](auto)
                                        { reload(); });
    reload();
}

GTE::~GTE() { listener.unlistenAll(); }
...
uint32_t GTE::read(uint8_t n)
{
    uint32_t ret = [this](uint8_t n) -> uint32_t
    {
        ...
        case 32:
            return ((uint16_t)rotation[0][1] << 16) | (uint16_t)rotation[0][0];
        case 33:
            return ((uint16_t)rotation[1][0] << 16) | (uint16_t)rotation[0][2];
        case 34:
            return ((uint16_t)rotation[1][2] << 16) | (uint16_t)rotation[1][1];
        case 35:
            return ((uint16_t)rotation[2][1] << 16) | (uint16_t)rotation[2][0];
        case 36:
            return (int32_t)rotation[2][2];
        case 37:
        ...
        case 40:
            return ((uint16_t)light[0][1] << 16) | (uint16_t)light[0][0];
        case 41:
            return ((uint16_t)light[1][0] << 16) | (uint16_t)light[0][2];
        case 42:
            return ((uint16_t)light[1][2] << 16) | (uint16_t)light[1][1];
        case 43:
            return ((uint16_t)light[2][1] << 16) | (uint16_t)light[2][0];
        case 44:
            return (int32_t)light[2][2];
        case 45:
        ...
        case 48:
            return ((uint16_t)color[0][1] << 16) | (uint16_t)color[0][0];
        case 49:
            return ((uint16_t)color[1][0] << 16) | (uint16_t)color[0][2];
        case 50:
            return ((uint16_t)color[1][2] << 16) | (uint16_t)color[1][1];
        case 51:
            return ((uint16_t)color[2][1] << 16) | (uint16_t)color[2][0];
        case 52:
            return (int32_t)color[2][2];
        case 53:
            return farColor.r;
        case 54:
            return farColor.g;
...
void GTE::command(gte::Command &cmd)
{
    ...
    case 0x11:
        ...
        break;
    case 0x12:
        mvmva(cmd.mvmvaMultiplyMatrix, cmd.mvmvaMultiplyVector, cmd.mvmvaTranslationVector);
        break;
    case 0x13:
        ncds();
        break;
